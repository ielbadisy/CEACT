...
**CEACT** *(Cost-Effectiveness Analysis Toolkit for Clinical Trials)* is an R
...
CEACT also includes `trial_cea`, a 500-patient example dataset with treatment,
total cost, and QALY outcomes used in teaching material for trial-based economic
evaluation.
